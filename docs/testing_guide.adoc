= Test-Leitfaden für SmartFactory Python Grundkurs
...
Dieser Leitfaden erklärt, wie die Tests für die Beispieldateien des SmartFactory Python Grundkurses verwendet werden. Die Tests helfen Studierenden dabei, die Funktionalität der Beispiele zu verstehen und eigene Test-Fähigkeiten zu entwickeln.
