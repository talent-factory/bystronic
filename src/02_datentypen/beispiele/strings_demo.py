...
"""
    ...
    for maschine in daten["maschinen"]:
        effizienz = (maschine["laufzeit"] / (maschine["laufzeit"] + maschine["ausfallzeit"])) * 100
        teile_pro_stunde = maschine["teile"] / maschine["laufzeit"] if maschine["laufzeit"] > 0 else 0
...
def formatiere_csv_daten():
    ...
    for daten in produktionsdaten:
        effizienz = (daten["Anzahl"] / daten["Zeit"]) / 60 * 100  # Teile pro Stunde als %
