...
def demonstriere_dictionaries():
    ...
    it_mitarbeiter = {
        emp_id: daten
        for emp_id, daten in mitarbeiter.items()
    ...
    python_entwickler = [
        daten["name"] for daten in mitarbeiter.values() if "Python" in daten["skills"]
    ]
...
def demonstriere_funktionen():
    ...
    def analysiere_gehaltsstruktur(
        mitarbeiter_daten: dict[str, dict[str, Any]],
    ) -> dict[str, float]:
